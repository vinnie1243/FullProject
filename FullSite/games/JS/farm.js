...
function newGame() {
    document.getElementById("coins").innerHTML = "Coins: 36"
    document.getElementById("coins").setAttribute("data", 36)
    genCust(1)
    genCust(2)
    genCust(3)
    genCust(4)
    ...
    for(var i = 0; i < 55 * 6; i++) {
        ...
        switch (crops[div][mod]) {
            ...
            case "EggplantT10":
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant10Img").src  
            ...
            case "EggplantT2":
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant2Img").src   
                el.appendChild(plant)
            break;
            case "EggplantT3":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant3Img").src
                el.appendChild(plant)
            break;
            case "EggplantT4":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant4Img").src
                el.appendChild(plant)
            break;
            case "EggplantT5":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant5Img").src
                el.appendChild(plant)
            break;
            case "EggplantT6":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant6Img").src
                el.appendChild(plant)
            break;
            case "EggplantT7":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant7Img").src
                el.appendChild(plant)
            break;
            case "EggplantT8":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant8Img").src 
                el.appendChild(plant)
            break;
            case "EggplantT9":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant9Img").src
                el.appendChild(plant)
            break;
            case "EggplantT1":
                var plant = document.createElement("img")
                ...
                plant.draggable = "true"
                plant.addEventListener("mouseenter", (e) => collect(e))
                plant.src = document.getElementById("Eggplant1Img").src 
                el.appendChild(plant)
            break;
            case "GrapeT1":
                var plant = document.createElement("img")
...
function renderMachines() {
    ...
    parent = parent.children[0]
    //Juicery
    var juiCon = document.createElement("div")
    var juiImg = document.createElement("img")
    var juiTxt = document.createElement("p")
    var juiBut = document.createElement("button")
    juiCon.classList.add("border")
    juiCon.classList.add("food")
    juiImg.src = document.getElementById("JuiceryIcon").src
    juiImg.classList.add("foodPic")
    juiTxt.innerHTML = "Juicery"
    juiBut.classList.add("foodButton")
    juiBut.setAttribute("onclick", "spawnMachine('juciery')")
    juiBut.innerHTML = "500 Coins"
    juiCon.appendChild(juiImg)
    juiCon.appendChild(juiTxt)
    juiCon.appendChild(juiBut)
    parent.appendChild(juiCon)
    //Cotton Mill
    var cotCon = document.createElement("div")
    var cotImg = document.createElement("img")
    var cotTxt = document.createElement("p")
    ...
    cotCon.classList.add("border")
    cotCon.classList.add("food")
    cotImg.src = document.getElementById("CottonMillIcon").src
    cotImg.classList.add("foodPic")
    cotTxt.innerHTML = "Cotton Mill"
    cotBut.classList.add("foodButton")
    cotBut.setAttribute("onclick", "spawnMachine('cotton')")
    cotBut.innerHTML = "1000 Coins"
    cotCon.appendChild(cotImg)
    cotCon.appendChild(cotTxt)
    cotCon.appendChild(cotBut)
    parent.appendChild(cotCon)
...
function renderAnimals() {
    ...
    parent = parent.children[0]
    //Sheep
    var sheCon = document.createElement("div")
    var sheImg = document.createElement("img")
    var sheTxt = document.createElement("p")
    var sheBut = document.createElement("button")
    sheCon.classList.add("border")
    sheCon.classList.add("food")
    sheImg.src = document.getElementById("SheepIcon").src
    sheImg.classList.add("foodPic")
    sheTxt.innerHTML = "Sheep"
    sheBut.classList.add("foodButton")
    sheBut.setAttribute("onclick", "spawnMachine('sheep')")
    sheBut.innerHTML = "1000 Coins"
    sheCon.appendChild(sheImg)
    sheCon.appendChild(sheTxt)
    sheCon.appendChild(sheBut)
    parent.appendChild(sheCon)
}
...
function spawnCrop(food) {
    switch (food) {
        ...
        case "wheat":
            ...
            var plant = document.createElement("img")
            plant.src = document.getElementById("Wheat1Img").src
            plant.classList.add("cropImage")
            plant.addEventListener("dragstart", (e) => drag(e))
            plant.draggable = "true"
            plant.addEventListener("mouseenter", (e) => collect(e))
...
function updataCropVals() { 
    ...
    for(var i = 0; i < arr.length; i++) {
        ...
        } else if(crop == "wheat" && teir == 3) {
            if(obj.wheat.T3 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 4) {
            if(obj.wheat.T4 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 5) {
            if(obj.wheat.T5 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 6) {
            if(obj.wheat.T6 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 7) {
            if(obj.wheat.T7 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 8) {
            if(obj.wheat.T8 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 9) {
            if(obj.wheat.T9 == 0) {
                upVal(el)
            }
        } else if(crop == "wheat" && teir == 10) {
            if(obj.wheat.T10 == 0) {
                upVal(el)
            }
        }
    ...
    window.sessionStorage.setItem("wheat", JSON.stringify(obj.wheat))
}
...
function upVal(el) {
    ...
    */
    ...
    if(crop == "tomato" && teir == 1) {
        ...
        if(plant.getAttribute("data") != 135) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
        ...
        if(plant.getAttribute("data") != 225) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
        ...
        if(plant.getAttribute("data") != 450) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 1) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 1) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 5) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 11) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 6) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 22) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 7) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 40) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 8) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 72) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 9) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 120) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
    ...
    } else if(crop == "eggplant" && teir == 10) {
        var plant = document.getElementById(el.id)
        if(plant.getAttribute("data") == undefined) {
            plant.setAttribute("data", 1)
        }
        if(plant.getAttribute("data") != 240) {
            var num = plant.getAttribute("data")
            num = Number.parseInt(num)
            num += 1
            plant.setAttribute("data", num)
...
function init() {
    ...
    window.sessionStorage.setItem("grape", JSON.stringify(grape))
    window.sessionStorage.setItem("eggplant", JSON.stringify(eggplant))
    window.sessionStorage.setItem("wheat", JSON.stringify(wheat))
...
function fig3(crop) {
    if(crop.includes("tomato")) {
        ...
        return "wheat"
    } else if(crop.includes("eggplant")) {
        return "eggplants"
    }
}
...
function merge(plant, n) {
    switch (plant) {
        ...
        case "wheatT1":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat2Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT2":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat3Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT3":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat4Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT4":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat5Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT5":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat6Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT6":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat7Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT7":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat8Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT8":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat9Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
        ...
        case "wheatT9":
            var img = document.createElement("img")
            img.src = document.getElementById("Wheat10Img").src
            img.classList.add("cropImage")
            img.addEventListener("drag", (e) => drag(e))
            img.addEventListener("mouseenter", (e) => collect(e)) 
            img.draggable = "true"
...
function cropId() {
    ...
    for(var j = 0; j < crops.length; j++) {
        ...
        if(crops[j].src.includes("T10")) {
            ...
            teir = 9
        } else if(crops[j].src.includes("T1")) {
            teir = 1
        }
        //find crop type
        crop = fig1(crops[j].src)
        if(crop == "tomato" && teir == 1) {
            tomato.T1 += 1
            ...
            wheat.T3 += 1
            crops[j].id = wheat.T3 + crop + teir 
        } else if(crop == "wheat" && teir == 4) {
            wheat.T4 += 1
            crops[j].id = wheat.T4 + crop + teir 
        } else if(crop == "wheat" && teir == 5) {
            wheat.T5 += 1
            crops[j].id = wheat.T5 + crop + teir 
        } else if(crop == "wheat" && teir == 6) {
            wheat.T6 += 1
            crops[j].id = wheat.T6 + crop + teir 
        } else if(crop == "wheat" && teir == 7) {
            wheat.T7 += 1
            crops[j].id = wheat.T7 + crop + teir 
        } else if(crop == "wheat" && teir == 8) {
            wheat.T8 += 1
            crops[j].id = wheat.T8 + crop + teir 
        } else if(crop == "wheat" && teir == 9) {
            wheat.T9 += 1
            crops[j].id = wheat.T9 + crop + teir 
        } else if(crop == "wheat" && teir == 10) {
            wheat.T10 += 1
            crops[j].id = wheat.T10 + crop + teir 
        } else if(crop == "eggplant" && teir == 1) {
            eggplant.T1 += 1
            crops[j].id = eggplant.T1 + crop + teir
        } else if(crop == "eggplant" && teir == 2) {
            eggplant.T2 += 1
            crops[j].id = eggplant.T2 + crop + teir
        } else if(crop == "eggplant" && teir == 3) {
            eggplant.T3 += 1
            crops[j].id = eggplant.T3 + crop + teir
        } else if(crop == "eggplant" && teir == 4) {
            eggplant.T4 += 1
            crops[j].id = eggplant.T4 + crop + teir
        } else if(crop == "eggplant" && teir == 5) {
            eggplant.T5 += 1
            crops[j].id = eggplant.T5 + crop + teir
        } else if(crop == "eggplant" && teir == 6) {
            eggplant.T6 += 1
            crops[j].id = eggplant.T6 + crop + teir
        } else if(crop == "eggplant" && teir == 7) {
            eggplant.T7 += 1
            crops[j].id = eggplant.T7 + crop + teir
        } else if(crop == "eggplant" && teir == 8) {
            eggplant.T8 += 1
            crops[j].id = eggplant.T8 + crop + teir
        } else if(crop == "eggplant" && teir == 9) {
            eggplant.T9 += 1
            crops[j].id = eggplant.T9 + crop + teir
        } else if(crop == "eggplant" && teir == 10) {
            eggplant.T10 += 1
            crops[j].id = eggplant.T10 + crop + teir
        } else if(crop == "grape" && teir == 1) {
            grape.T1 += 1
            crops[j].id = grape.T1 + crop + teir
        } else if(crop == "grape" && teir == 2) {
            grape.T2 += 1
            crops[j].id = grape.T2 + crop + teir
        } else if(crop == "grape" && teir == 3) {
            grape.T3 += 1
            crops[j].id = grape.T3 + crop + teir
        } else if(crop == "grape" && teir == 4) {
            grape.T4 += 1
            crops[j].id = grape.T4 + crop + teir
        } else if(crop == "grape" && teir == 5) {
            grape.T5 += 1
            crops[j].id = grape.T5 + crop + teir
        } else if(crop == "grape" && teir == 6) {
            grape.T6 += 1
            crops[j].id = grape.T6 + crop + teir
        } else if(crop == "grape" && teir == 7) {
            grape.T7 += 1
            crops[j].id = grape.T7 + crop + teir
        } else if(crop == "grape" && teir == 8) {
            grape.T8 += 1
            crops[j].id = grape.T8 + crop + teir
        } else if(crop == "grape" && teir == 9) {
            grape.T9 += 1
            crops[j].id = grape.T9 + crop + teir
        } else if(crop == "grape" && teir == 10) {
            grape.T10 += 1
            crops[j].id = grape.T10 + crop + teir
        } else if(crop == "carrot" && teir == 1) {
            carrot.T1 += 1
            crops[j].id = carrot.T1 + crop + teir
        } else if(crop == "carrot" && teir == 2) {
            carrot.T2 += 1
            crops[j].id = carrot.T2 + crop + teir
        } else if(crop == "carrot" && teir == 3) {
            carrot.T3 += 1
            crops[j].id = carrot.T3 + crop + teir
        } else if(crop == "carrot" && teir == 4) {
            carrot.T4 += 1
            crops[j].id = carrot.T4 + crop + teir
        } else if(crop == "carrot" && teir == 5) {
            carrot.T5 += 1
            crops[j].id = carrot.T5 + crop + teir
        } else if(crop == "carrot" && teir == 6) {
            carrot.T6 += 1
            crops[j].id = carrot.T6 + crop + teir
        } else if(crop == "carrot" && teir == 7) {
            carrot.T7 += 1
            crops[j].id = carrot.T7 + crop + teir
        } else if(crop == "carrot" && teir == 8) {
            carrot.T8 += 1
            crops[j].id = carrot.T8 + crop + teir
        } else if(crop == "carrot" && teir == 9) {
            carrot.T9 += 1
            crops[j].id = carrot.T9 + crop + teir
        } else if(crop == "carrot" && teir == 10) {
            carrot.T10 += 1
            crops[j].id = carrot.T10 + crop + teir
        } else if(crop == "pumpkin" && teir == 1) {
            pumpkin.T1 += 1
            crops[j].id = pumpkin.T1 + crop + teir
        } else if(crop == "pumpkin" && teir == 2) {
            pumpkin.T2 += 1
            crops[j].id = pumpkin.T2 + crop + teir
        } else if(crop == "pumpkin" && teir == 3) {
            pumpkin.T3 += 1
            crops[j].id = pumpkin.T3 + crop + teir
        } else if(crop == "pumpkin" && teir == 4) {
            pumpkin.T4 += 1
            crops[j].id = pumpkin.T4 + crop + teir
        } else if(crop == "pumpkin" && teir == 5) {
            pumpkin.T5 += 1
            crops[j].id = pumpkin.T5 + crop + teir
        } else if(crop == "pumpkin" && teir == 6) {
            pumpkin.T6 += 1
            crops[j].id = pumpkin.T6 + crop + teir
        } else if(crop == "pumpkin" && teir == 7) {
            pumpkin.T7 += 1
            crops[j].id = pumpkin.T7 + crop + teir
        } else if(crop == "pumpkin" && teir == 8) {
            pumpkin.T8 += 1
            crops[j].id = pumpkin.T8 + crop + teir
        } else if(crop == "pumpkin" && teir == 9) {
            pumpkin.T9 += 1
            crops[j].id = pumpkin.T9 + crop + teir
        } else if(crop == "pumpkin" && teir == 10) {
            pumpkin.T10 += 1
            crops[j].id = pumpkin.T10 + crop + teir
        } else if(crop == "pepper" && teir == 1) {
            pepper.T1 += 1
            crops[j].id = pepper.T1 + crop + teir
        } else if(crop == "pepper" && teir == 2) {
            pepper.T2 += 1
            crops[j].id = pepper.T2 + crop + teir
        } else if(crop == "pepper" && teir == 3) {
            pepper.T3 += 1
            crops[j].id = pepper.T3 + crop + teir
        } else if(crop == "pepper" && teir == 4) {
            pepper.T4 += 1
            crops[j].id = pepper.T4 + crop + teir
        } else if(crop == "pepper" && teir == 5) {
            pepper.T5 += 1
            crops[j].id = pepper.T5 + crop + teir
        } else if(crop == "pepper" && teir == 6) {
            pepper.T6 += 1
            crops[j].id = pepper.T6 + crop + teir
        } else if(crop == "pepper" && teir == 7) {
            pepper.T7 += 1
            crops[j].id = pepper.T7 + crop + teir
        } else if(crop == "pepper" && teir == 8) {
            pepper.T8 += 1
            crops[j].id = pepper.T8 + crop + teir
        } else if(crop == "pepper" && teir == 9) {
            pepper.T9 += 1
            crops[j].id = pepper.T9 + crop + teir
        } else if(crop == "pepper" && teir == 10) {
            pepper.T10 += 1
            crops[j].id = pepper.T10 + crop + teir
        } else if(crop == "cucumber" && teir == 1) {
            cucumber.T1 += 1
            crops[j].id = cucumber.T1 + crop + teir
        } else if(crop == "cucumber" && teir == 2) {
            cucumber.T2 += 1
            crops[j].id = cucumber.T2 + crop + teir
        } else if(crop == "cucumber" && teir == 3) {
            cucumber.T3 += 1
            crops[j].id = cucumber.T3 + crop + teir
        } else if(crop == "cucumber" && teir == 4) {
            cucumber.T4 += 1
            crops[j].id = cucumber.T4 + crop + teir
        } else if(crop == "cucumber" && teir == 5) {
            cucumber.T5 += 1
            crops[j].id = cucumber.T5 + crop + teir
        } else if(crop == "cucumber" && teir == 6) {
            cucumber.T6 += 1
            crops[j].id = cucumber.T6 + crop + teir
        } else if(crop == "cucumber" && teir == 7) {
            cucumber.T7 += 1
            crops[j].id = cucumber.T7 + crop + teir
        } else if(crop == "cucumber" && teir == 8) {
            cucumber.T8 += 1
            crops[j].id = cucumber.T8 + crop + teir
        } else if(crop == "cucumber" && teir == 9) {
            cucumber.T9 += 1
            crops[j].id = cucumber.T9 + crop + teir
        } else if(crop == "cucumber" && teir == 10) {
            cucumber.T1 += 10
            crops[j].id = cucumber.T10 + crop + teir
        } else if(crop == "blueberry" && teir == 1) {
            blueberry.T1 += 1
            crops[j].id = blueberry.T1 + crop + teir
        } else if(crop == "blueberry" && teir == 2) {
            blueberry.T2 += 1
            crops[j].id = blueberry.T2 + crop + teir
        } else if(crop == "blueberry" && teir == 3) {
            blueberry.T3 += 1
            crops[j].id = blueberry.T3 + crop + teir
        } else if(crop == "blueberry" && teir == 4) {
            blueberry.T4 += 1
            crops[j].id = blueberry.T4 + crop + teir
        } else if(crop == "blueberry" && teir == 5) {
            blueberry.T5 += 1
            crops[j].id = blueberry.T5 + crop + teir
        } else if(crop == "blueberry" && teir == 6) {
            blueberry.T6 += 1
            crops[j].id = blueberry.T6 + crop + teir
        } else if(crop == "blueberry" && teir == 7) {
            blueberry.T7 += 1
            crops[j].id = blueberry.T7 + crop + teir
        } else if(crop == "blueberry" && teir == 8) {
            blueberry.T8 += 1
            crops[j].id = blueberry.T8 + crop + teir
        } else if(crop == "blueberry" && teir == 9) {
            blueberry.T9 += 1
            crops[j].id = blueberry.T9 + crop + teir
        } else if(crop == "blueberry" && teir == 10) {
            blueberry.T10 += 1
            crops[j].id = blueberry.T10 + crop + teir
        } else if(crop == "cabbage" && teir == 1) {
            cabbage.T1 += 1
            crops[j].id = cabbage.T1 + crop + teir
        } else if(crop == "cabbage" && teir == 2) {
            cabbage.T2 += 1
            crops[j].id = cabbage.T2 + crop + teir
        } else if(crop == "cabbage" && teir == 3) {
            cabbage.T3 += 1
            crops[j].id = cabbage.T3 + crop + teir
        } else if(crop == "cabbage" && teir == 4) {
            cabbage.T4 += 1
            crops[j].id = cabbage.T4 + crop + teir
        } else if(crop == "cabbage" && teir == 5) {
            cabbage.T5 += 1
            crops[j].id = cabbage.T5 + crop + teir
        } else if(crop == "cabbage" && teir == 6) {
            cabbage.T6 += 1
            crops[j].id = cabbage.T6 + crop + teir
        } else if(crop == "cabbage" && teir == 7) {
            cabbage.T7 += 1
            crops[j].id = cabbage.T7 + crop + teir
        } else if(crop == "cabbage" && teir == 8) {
            cabbage.T8 += 1
            crops[j].id = cabbage.T8 + crop + teir
        } else if(crop == "cabbage" && teir == 9) {
            cabbage.T9 += 1
            crops[j].id = cabbage.T9 + crop + teir
        } else if(crop == "cabbage" && teir == 10) {
            cabbage.T10 += 1
            crops[j].id = cabbage.T10 + crop + teir
        } else if(crop == "corn" && teir == 1) {
            corn.T1 += 1
            crops[j].id = corn.T1 + crop + teir
        } else if(crop == "corn" && teir == 2) {
            corn.T2 += 1
            crops[j].id = corn.T2 + crop + teir
        } else if(crop == "corn" && teir == 3) {
            corn.T3 += 1
            crops[j].id = corn.T3 + crop + teir
        } else if(crop == "corn" && teir == 4) {
            corn.T4 += 1
            crops[j].id = corn.T4 + crop + teir
        } else if(crop == "corn" && teir == 5) {
            corn.T5 += 1
            crops[j].id = corn.T5 + crop + teir
        } else if(crop == "corn" && teir == 6) {
            corn.T6 += 1
            crops[j].id = corn.T6 + crop + teir
        } else if(crop == "corn" && teir == 7) {
            corn.T7 += 1
            crops[j].id = corn.T7 + crop + teir
        } else if(crop == "corn" && teir == 8) {
            corn.T8 += 1
            crops[j].id = corn.T8 + crop + teir
        } else if(crop == "corn" && teir == 9) {
            corn.T9 += 1
            crops[j].id = corn.T9 + crop + teir
        } else if(crop == "corn" && teir == 10) {
            corn.T10 += 1
            crops[j].id = corn.T10 + crop + teir
        } else if(crop == "potato" && teir == 1) {
            potato.T1 += 1
            crops[j].id = potato.T1 + crop + teir
        } else if(crop == "potato" && teir == 2) {
            potato.T2 += 1
            crops[j].id = potato.T2 + crop + teir
        } else if(crop == "potato" && teir == 3) {
            potato.T3 += 1
            crops[j].id = potato.T3 + crop + teir
        } else if(crop == "potato" && teir == 4) {
            potato.T4 += 1
            crops[j].id = potato.T4 + crop + teir
        } else if(crop == "potato" && teir == 5) {
            potato.T5 += 1
            crops[j].id = potato.T5 + crop + teir
        } else if(crop == "potato" && teir == 6) {
            potato.T6 += 1
            crops[j].id = potato.T6 + crop + teir
        } else if(crop == "potato" && teir == 7) {
            potato.T7 += 1
            crops[j].id = potato.T7 + crop + teir
        } else if(crop == "potato" && teir == 8) {
            potato.T8 += 1
            crops[j].id = potato.T8 + crop + teir
        } else if(crop == "potato" && teir == 9) {
            potato.T9 += 1
            crops[j].id = potato.T9 + crop + teir
        } else if(crop == "potato" && teir == 10) {
            potato.T10 += 1
            crops[j].id = potato.T10 + crop + teir
        } else if(crop == "strawberry" && teir == 1) {
            strawberry.T1 += 1
            crops[j].id = strawberry.T1 + crop + teir
        } else if(crop == "strawberry" && teir == 2) {
            strawberry.T2 += 1
            crops[j].id = strawberry.T2 + crop + teir
        } else if(crop == "strawberry" && teir == 3) {
            strawberry.T3 += 1
            crops[j].id = strawberry.T3 + crop + teir
        } else if(crop == "strawberry" && teir == 4) {
            strawberry.T4 += 1
            crops[j].id = strawberry.T4 + crop + teir
        } else if(crop == "strawberry" && teir == 5) {
            strawberry.T5 += 1
            crops[j].id = strawberry.T5 + crop + teir
        } else if(crop == "strawberry" && teir == 6) {
            strawberry.T6 += 1
            crops[j].id = strawberry.T6 + crop + teir
        } else if(crop == "strawberry" && teir == 7) {
            strawberry.T7 += 1
            crops[j].id = strawberry.T7 + crop + teir
        } else if(crop == "strawberry" && teir == 8) {
            strawberry.T8 += 1
            crops[j].id = strawberry.T8 + crop + teir
        } else if(crop == "strawberry" && teir == 9) {
            strawberry.T9 += 1
            crops[j].id = strawberry.T9 + crop + teir
        } else if(crop == "strawberry" && teir == 10) {
            strawberry.T10 += 1
            crops[j].id = strawberry.T10 + crop + teir
        } else if(crop == "watermelon" && teir == 1) {
            watermelon.T1 += 1
            crops[j].id = watermelon.T1 + crop + teir
        } else if(crop == "watermelon" && teir == 2) {
            watermelon.T2 += 1
            crops[j].id = watermelon.T2 + crop + teir
        } else if(crop == "watermelon" && teir == 3) {
            watermelon.T3 += 1
            crops[j].id = watermelon.T3 + crop + teir
        } else if(crop == "watermelon" && teir == 4) {
            watermelon.T4 += 1
            crops[j].id = watermelon.T4 + crop + teir
        } else if(crop == "watermelon" && teir == 5) {
            watermelon.T5 += 1
            crops[j].id = watermelon.T5 + crop + teir
        } else if(crop == "watermelon" && teir == 6) {
            watermelon.T6 += 1
            crops[j].id = watermelon.T6 + crop + teir
        } else if(crop == "watermelon" && teir == 7) {
            watermelon.T7 += 1
            crops[j].id = watermelon.T7 + crop + teir
        } else if(crop == "watermelon" && teir == 8) {
            watermelon.T8 += 1
            crops[j].id = watermelon.T8 + crop + teir
        } else if(crop == "watermelon" && teir == 9) {
            watermelon.T9 += 1
            crops[j].id = watermelon.T9 + crop + teir
        } else if(crop == "watermelon" && teir == 10) {
            watermelon.T10 += 1
            crops[j].id = watermelon.T10 + crop + teir
        } else if(crop == "apple" && teir == 1) {
            apple.T1 += 1
            crops[j].id = apple.T1 + crop + teir
        } else if(crop == "apple" && teir == 2) {
            apple.T2 += 1
            crops[j].id = apple.T2 + crop + teir
        } else if(crop == "apple" && teir == 3) {
            apple.T3 += 1
            crops[j].id = apple.T3 + crop + teir
        } else if(crop == "apple" && teir == 4) {
            apple.T4 += 1
            crops[j].id = apple.T4 + crop + teir
        } else if(crop == "apple" && teir == 5) {
            apple.T5 += 1
            crops[j].id = apple.T5 + crop + teir
        } else if(crop == "apple" && teir == 6) {
            apple.T6 += 1
            crops[j].id = apple.T6 + crop + teir
        } else if(crop == "apple" && teir == 7) {
            apple.T7 += 1
            crops[j].id = apple.T7 + crop + teir
        } else if(crop == "apple" && teir == 8) {
            apple.T8 += 1
            crops[j].id = apple.T8 + crop + teir
        } else if(crop == "apple" && teir == 9) {
            apple.T9 += 1
            crops[j].id = apple.T9 + crop + teir
        } else if(crop == "apple" && teir == 10) {
            apple.T10 += 1
            crops[j].id = apple.T10 + crop + teir
        } else if(crop == "cherry" && teir == 1) {
            cherry.T1 += 1
            crops[j].id = cherry.T1 + crop + teir
        } else if(crop == "cherry" && teir == 2) {
            cherry.T2 += 1
            crops[j].id = cherry.T2 + crop + teir
        } else if(crop == "cherry" && teir == 3) {
            cherry.T3 += 1
            crops[j].id = cherry.T3 + crop + teir
        } else if(crop == "cherry" && teir == 4) {
            cherry.T4 += 1
            crops[j].id = cherry.T4 + crop + teir
        } else if(crop == "cherry" && teir == 5) {
            cherry.T5 += 1
            crops[j].id = cherry.T5 + crop + teir
        } else if(crop == "cherry" && teir == 6) {
            cherry.T6 += 1
            crops[j].id = cherry.T6 + crop + teir
        } else if(crop == "cherry" && teir == 7) {
            cherry.T7 += 1
            crops[j].id = cherry.T7 + crop + teir
        } else if(crop == "cherry" && teir == 8) {
            cherry.T8 += 1
            crops[j].id = cherry.T8 + crop + teir
        } else if(crop == "cherry" && teir == 9) {
            cherry.T9 += 1
            crops[j].id = cherry.T9 + crop + teir
        } else if(crop == "cherry" && teir == 10) {
            cherry.T10 += 1
            crops[j].id = cherry.T10 + crop + teir
        } else if(crop == "beetroot" && teir == 1) {
            beetroot.T1 += 1
            crops[j].id = beetroot.T1 + crop + teir
        } else if(crop == "beetroot" && teir == 2) {
            beetroot.T2 += 1
            crops[j].id = beetroot.T2 + crop + teir
        } else if(crop == "beetroot" && teir == 3) {
            beetroot.T3 += 1
            crops[j].id = beetroot.T3 + crop + teir
        } else if(crop == "beetroot" && teir == 4) {
            beetroot.T4 += 1
            crops[j].id = beetroot.T4 + crop + teir
        } else if(crop == "beetroot" && teir == 5) {
            beetroot.T5 += 1
            crops[j].id = beetroot.T5 + crop + teir
        } else if(crop == "beetroot" && teir == 6) {
            beetroot.T6 += 1
            crops[j].id = beetroot.T6 + crop + teir
        } else if(crop == "beetroot" && teir == 7) {
            beetroot.T7 += 1
            crops[j].id = beetroot.T7 + crop + teir
        } else if(crop == "beetroot" && teir == 8) {
            beetroot.T8 += 1
            crops[j].id = beetroot.T8 + crop + teir
        } else if(crop == "beetroot" && teir == 9) {
            beetroot.T9 += 1
            crops[j].id = beetroot.T9 + crop + teir
        } else if(crop == "beetroot" && teir == 10) {
            beetroot.T10 += 1
            crops[j].id = beetroot.T10 + crop + teir
        }   
    }
}
...
function collect(e) {
    ...
    if(crop == "tomato") {
        ...
        var eggplant = document.getElementById("eggplants")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        eggplant.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        eggplant.innerHTML = `Eggplants: ${cropCount + num}`
    } else if(crop == "grape") {
        var grape = document.getElementById("grapes")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        grape.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        eggplant.innerHTML = `Grapes: ${cropCount + num}`
    } else if(crop == "carrot") {
        ...
        cropCount = Number.parseInt(cropCount)
        carrot.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        carrot.innerHTML = `Carrots: ${cropCount + num}`
    } else if(crop == "pumpkin") {
        var pumpkin = document.getElementById("pumpkins")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        pumpkin.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        pumpkin.innerHTML = `Pumpkins: ${cropCount + num}`
    } else if(crop == "pepper") {
        var pepper = document.getElementById("peppers")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        pepper.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        pepper.innerHTML = `Peppers: ${cropCount + num}`
    } else if(crop == "cucumber") {
        var cucumber = document.getElementById("cucumbers")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        cucumber.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        cucumber.innerHTML = `Cucumbers: ${cropCount + num}`
    } else if(crop == "blueberry") {
        var blueberry = document.getElementById("blueberries")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        blueberry.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        blueberry.innerHTML = `Blueberries: ${cropCount + num}`
    } else if(crop == "cabbage") {
        var cabbage = document.getElementById("cabbages")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        cabbage.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        cabbage.innerHTML = `Cabbages: ${cropCount + num}`
    } else if(crop == "corn") {
        ...
        cropCount = Number.parseInt(cropCount)
        corn.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        corn.innerHTML = `Corn: ${cropCount + num}`
    } else if(crop == "potato") {
        var potato = document.getElementById("potatoes")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        potato.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        potato.innerHTML = `Potatoes: ${cropCount + num}`
    } else if(crop == "strawberry") {
        var strawberry = document.getElementById("strawberries")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        strawberry.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        strawberry.innerHTML = `Strawberries: ${cropCount + num}`
    } else if(crop == "watermelon") {
        var watermelon = document.getElementById("watermelons")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        watermelon.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        watermelon.innerHTML = `Watermelons: ${cropCount + num}`
    } else if(crop == "apple") {
        var apple = document.getElementById("apples")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        apple.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        apple.innerHTML = `Apples: ${cropCount + num}`
    } else if(crop == "cherry") {
        var cherry = document.getElementById("cherries")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        cherry.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        cherry.innerHTML = `Cherries: ${cropCount + num}`
    } else if(crop == "beetroot") {
        var beetroot = document.getElementById("beetroots")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        beetroot.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        beetroot.innerHTML = `Beetroots: ${cropCount + num}`
    } else if(crop == "avocado") {
        var avocado = document.getElementById("avocados")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        avocado.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        avocado.innerHTML = `Eggplants: ${cropCount + num}`
    } else if(crop == "cotton") {
        ...
        cropCount = Number.parseInt(cropCount)
        cotton.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        cotton.innerHTML = `Cotton: ${cropCount + num}`
    } else if(crop == "orange") {
        var orange = document.getElementById("oranges")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        orange.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        orange.innerHTML = `Oranges: ${cropCount + num}`
    } else if(crop == "lime") {
        var lime = document.getElementById("limes")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        lime.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        lime.innerHTML = `Limes: ${cropCount + num}`
    } else if(crop == "pineapple") {
        var pineapple = document.getElementById("pineapples")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        pineapple.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        pineapple.innerHTML = `Pineapples: ${cropCount + num}`
    } else if(crop == "kiwi") {
        var kiwi = document.getElementById("kiwis")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        kiwi.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        kiwi.innerHTML = `Kiwis: ${cropCount + num}`
    } else if(crop == "peach") {
        var peach = document.getElementById("peachs")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        peach.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        peach.innerHTML = `Peachs: ${cropCount + num}`
    } else if(crop == "fig") {
        var fig = document.getElementById("figs")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        fig.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        fig.innerHTML = `Figs: ${cropCount + num}`
    } else if(crop == "pear") {
        var pear = document.getElementById("pears")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        pear.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        pear.innerHTML = `Pears: ${cropCount + num}`
    } else if(crop == "pomegranate") {
        var pomegranate = document.getElementById("pomegranates")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        pomegranate.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        pomegranate.innerHTML = `Pomegranates: ${cropCount + num}`
    } else if(crop == "coffee") {
        ...
        cropCount = Number.parseInt(cropCount)
        coffee.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        coffee.innerHTML = `Coffee: ${cropCount + num}`
    } else if(crop == "banana") {
        var banana = document.getElementById("Bananas")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        banana.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        banana.innerHTML = `Bananas: ${cropCount + num}`
    } else if(crop == "lemon") {
        var lemon = document.getElementById("lemons")
        var num = wheat.getAttribute("data") 
        num = Number.parseInt(num)
        if(num == null || num == undefined || num == NaN) {
            num = 0
        ...
        cropCount = Number.parseInt(cropCount)
        lemon.setAttribute("data",  cropCount + num)
        plant.setAttribute("data", 0)
        if(plant.parentElement.classList.contains("full")) {
            plant.parentElement.classList.remove("full")
        }
        lemon.innerHTML = `Lemons: ${cropCount + num}`
    }
}  
...
function visitorLog(name, xp, gender, worth) {
    ...
    var old
    if(minute.length == 1) {
        var time = `${month}/${day}/${year} ${hrs}:0${minute}`
    } else {
        var time = `${month}/${day}/${year} ${hrs}:${minute}`
    }
